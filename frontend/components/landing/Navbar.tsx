        ...
        <header className="fixed top-0 left-0 right-0 z-50 border-b border-[#27272A] bg-[#09090B]/80 backdrop-blur-md">
            <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                <Link href="/" className="flex items-center gap-2.5" aria-label="GymTracker Pro home">
                    <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#EF4444]">
                        <svg aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6.5 6.5C6.5 5.67157 7.17157 5 8 5C8.82843 5 9.5 5.67157 9.5 6.5V17.5C9.5 18.3284 8.82843 19 8 19C7.17157 19 6.5 18.3284 6.5 17.5V6.5Z" fill="white" />
                            <path d="M14.5 6.5C14.5 5.67157 15.1716 5 16 5C16.8284 5 17.5 5.67157 17.5 6.5V17.5C17.5 18.3284 16.8284 19 16 19C15.1716 19 14.5 18.3284 14.5 17.5V6.5Z" fill="white" />
                            <path d="M3 10C3 9.17157 3.67157 8.5 4.5 8.5H6.5V15.5H4.5C3.67157 15.5 3 14.8284 3 14V10Z" fill="white" />
                            <path d="M17.5 8.5H19.5C20.3284 8.5 21 9.17157 21 10V14C21 14.8284 20.3284 15.5 19.5 15.5H17.5V8.5Z" fill="white" />
                ...
                <div className="hidden items-center gap-3 md:flex">
                    <Link href="/auth/login" className="text-sm text-[#A1A1AA] transition-colors hover:text-[#FAFAFA]">
                        Login
                    </Link>
                    <Link href="/auth/register" className="rounded-md bg-[#EF4444] px-4 py-1.5 text-sm font-semibold text-[#FAFAFA] transition-opacity hover:opacity-90">
                        Get Started
                    </Link>
                </div>
            ...
            {mobileOpen && (
                <nav aria-label="Mobile navigation" className="border-t border-[#27272A] bg-[#09090B] px-4 pb-4 md:hidden">
